...
using ejemploAJAX.Infraestructure;
using System;
...
namespace ejemploAJAX.Services.Administracion
{
    public class EstudianteService : IEstudianteService
    {
        ...
        public IList<String> SearchInfo(String documento)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "buscarEstudiante";
        ...
        public IList<String> DeleteInfo(int id)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "eliminarEstudiante";
        ...
        public IList<String> ListInfo()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "listarEstudiante";
        ...
        public IList<String> LoadMunicipio(int departamento)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "cargarMunicipio";
